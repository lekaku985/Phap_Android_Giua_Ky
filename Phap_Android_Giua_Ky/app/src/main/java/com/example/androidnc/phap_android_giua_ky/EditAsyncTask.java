...
public class EditAsyncTask extends AsyncTask<String,Void, JSONObject> {
    private IView mView;
    private Map<String, String> map;


    public EditAsyncTask(IView iView, Map<String, String> map) {
        this.mView = iView;
        this.map = map;
    }
    ...
    protected void onPostExecute(JSONObject jsonObject) {
        ...
        try {
            ...
            if(mResult > 0){
                mView.onSuccess(response_message);
            }else{
                mView.onFail(response_message);
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
